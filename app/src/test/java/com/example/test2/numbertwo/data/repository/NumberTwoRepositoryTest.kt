package com.example.test2.numbertwo.data.repository
...
open class NumberTwoRepositoryTest {
    ...
    fun setUp() {
        ...
        NumberTwoRepositoryImpl.initialize(NumberTwoDAOImpl, testDispatcher)
    }
    ...
    fun insert_and_deleteAll_should_emit_changes_after_insert_and_emit_after_deleteAll() = testScope.runTest {
        ...
        val emissions = mutableListOf<List<NumberTwoEntity>>()
        ...
        NumberTwoRepositoryImpl.insert(
            NumberTwoEntity(
                id = 0L,
        ...
        NumberTwoRepositoryImpl.deleteAll()
        advanceUntilIdle()
        thirdEmission.await()
        collectorJob.join()
    ...
    fun insert_and_delete_should_emit_changes_after_insert_and_emit_after_delete() = testScope.runTest {
        ...
        advanceUntilIdle()
        val entity : NumberTwoEntity= NumberTwoEntity(
            id = 0L,
            date = OffsetDateTime.now(),
        )
        ...
        NumberTwoRepositoryImpl.delete(entity)
        advanceUntilIdle()
        thirdEmission.await()
        collectorJob.join()
        assertEquals(3, emissions.size)
    ...
    fun insert_should_emit_changes_after_insert_pagination_simple() = testScope.runTest {
        ...
        advanceUntilIdle()
        var entity : NumberTwoEntity= NumberTwoEntity(
            id = 0L,
            date = OffsetDateTime.now(),
        )
